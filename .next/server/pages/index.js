...
async function getStaticProps() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://gil:test1234@cluster0.l3sni.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (HomePage); // const MEETUPS = [
// 	{
// 		id: 'm1',
// 		image:
